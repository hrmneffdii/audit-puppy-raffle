...
contract PuppyRaffle is ERC721, Ownable {
    ...
    function enterRaffle(address[] memory newPlayers) public payable {
        // q were custom reverts a thing solidity 0.7.6?
        // how if lengh of newPlayers == 0?
    ...
    function getActivePlayerIndex(address player) external view returns (uint256) {
        ...
        // q what if player at index 0?
        // @audit if the player at index 0, it will return 0 and a player might think they are not active! 
        return 0;
    }
    ...
    function selectWinner() external {
        // q is this function follow CEI?
        // are the duration & start time being set correct?
